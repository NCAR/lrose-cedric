...
void nexrad_rdbeam();
int read_nexrad_ray(float flddat[MXFLD][MXGAT],char cfldnam[MXFLD][8],
                    float gatspac[MXFLD],int nrng[MXFLD], 
                    float rng_first_gate[MXFLD],int swap,int *number_of_rays);
...
void init_gate_info(int nrng[MXFLD],float gatspac[MXFLD],
                    float rng_first_gate[MXFLD]);
